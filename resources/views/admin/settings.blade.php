...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem">
  ...
  <div class="card">
    ...
    <div style="padding:.8rem 1.2rem;display:flex;flex-direction:column;gap:.55rem">
      @foreach([
        ...
        ['Debug mode', config('app.debug') ? 'ON - warning' : 'OFF - ok'],
      ...
      <div style="display:flex;justify-content:space-between;gap:.5rem;padding:.35rem 0;border-bottom:1px solid rgba(255,255,255,.03)">
        ...
        <span style="font-family:var(--mono);font-size:.68rem;color:{{ str_contains((string) $value, 'warning') ? 'var(--coral)' : 'var(--ink2)' }}">
          {{ $value ?? '-' }}
        </span>
      </div>
      @endforeach
  ...
  <div class="card">
    ...
    <div style="padding:.8rem 1.2rem;display:flex;flex-direction:column;gap:.55rem">
      ...
      <div style="display:flex;justify-content:space-between;gap:.5rem;padding:.35rem 0;border-bottom:1px solid rgba(255,255,255,.03)">
        <span style="font-family:var(--mono);font-size:.6rem;color:var(--ink3)">{{ $label }}</span>
        <span style="font-family:var(--mono);font-size:.68rem;color:{{ str_contains((string) $value, 'Missing') || str_contains((string) $value, 'Not set') ? 'var(--coral)' : 'var(--green)' }}">
          {{ $value }}
        </span>
      </div>
      @endforeach
  ...
  <div class="card">
    ...
    <div style="padding:.8rem 1.2rem;display:flex;flex-direction:column;gap:.55rem">
      ...
      <div style="display:flex;justify-content:space-between;gap:.5rem;padding:.35rem 0;border-bottom:1px solid rgba(255,255,255,.03)">
        <span style="font-family:var(--mono);font-size:.6rem;color:var(--ink3)">{{ $label }}</span>
        <span style="font-family:var(--mono);font-size:.65rem;color:{{ str_contains((string) $value, 'Missing') || str_contains((string) $value, 'Not set') ? 'var(--coral)' : 'var(--green)' }};word-break:break-all;text-align:right;max-width:180px">
          {{ $value }}
        </span>
      </div>
      @endforeach
  ...
  <div class="card">
    ...
    <div style="padding:.8rem 1.2rem;display:flex;flex-direction:column;gap:.55rem">
      @foreach([
        ['OpenAI API', config('proofwork.openai_api_key') ? 'Set' : 'Missing - AI summaries disabled'],
      ...
      <div style="display:flex;justify-content:space-between;gap:.5rem;padding:.35rem 0;border-bottom:1px solid rgba(255,255,255,.03)">
        <span style="font-family:var(--mono);font-size:.6rem;color:var(--ink3)">{{ $label }}</span>
        <span style="font-family:var(--mono);font-size:.65rem;color:{{ str_contains((string) $value, 'Missing') ? 'var(--coral)' : (str_contains((string) $value, 'Set') ? 'var(--green)' : 'var(--ink2)') }};text-align:right;max-width:200px">
          {{ $value }}
        </span>
      </div>
      @endforeach
